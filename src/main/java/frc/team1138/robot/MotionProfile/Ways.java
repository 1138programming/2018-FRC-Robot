...
public class Ways {
    ...
    public static final Waypoint[] LEFT_NEAR_SWITCH = new Waypoint[] {
        new Waypoint(1.75 ,23.166666666666668 ,Pathfinder.d2r(0)),
        new Waypoint(10.083333333333334 ,25.333333333333332 ,Pathfinder.d2r(0)),
        new Waypoint(14.25 ,21.666666666666668 ,Pathfinder.d2r(-90.0))
    };

    public static final Waypoint[] LEFT_NEAR_SCALE = new Waypoint[]{
        new Waypoint(1.75 ,23.166666666666668 ,Pathfinder.d2r(0)),
        new Waypoint(12.5 ,25.333333333333332 ,Pathfinder.d2r(0)),
        new Waypoint(23.75 ,25.333333333333332 ,Pathfinder.d2r(0)),
        new Waypoint(26 ,24 ,Pathfinder.d2r(-90.0))
    };
